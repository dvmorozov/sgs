...
{
    [TestClass()]
    public class ProcedureGetFilteredElementsUnitTest : DatabaseTestClass
    {

        public ProcedureGetFilteredElementsUnitTest()
        {
            InitializeComponent();
        }
        ...
        [TestMethod()]
        public void DBTestScript_GetFilteredElements()
        {
            DatabaseTestActions testActions = this.DBTestScript_GetFilteredElementsData;
        ...
        private DatabaseTestActions DBTestScript_GetFilteredElementsData;
    }
}
