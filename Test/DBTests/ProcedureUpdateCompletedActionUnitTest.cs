...
{
    [TestClass()]
    public class ProcedureUpdateCompletedActionUnitTest : DatabaseTestClass
    {

        public ProcedureUpdateCompletedActionUnitTest()
        {
            InitializeComponent();
        }
        ...
        [TestMethod()]
        public void DBTestScript_UpdateCompletedAction()
        {
            DatabaseTestActions testActions = this.DBTestScript_UpdateCompletedActionData;
        ...
        private DatabaseTestActions DBTestScript_UpdateCompletedActionData;
    }
}
