...
{
    [TestClass()]
    public class ProcedureUpdateChartSetsChartsUnitTest : DatabaseTestClass
    {

        public ProcedureUpdateChartSetsChartsUnitTest()
        {
            InitializeComponent();
        }
        ...
        [TestMethod()]
        public void DBTestScript_UpdateChartSetsCharts()
        {
            DatabaseTestActions testActions = this.DBTestScript_UpdateChartSetsChartsData;
        ...
        private DatabaseTestActions DBTestScript_UpdateChartSetsChartsData;
    }
}
